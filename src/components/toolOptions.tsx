    ...
    return (
        <>
            ...
            <fieldset className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-3">
                    <OptionContainer selected={String(mainState.arrowStructure)} value="curve" onClick={handleArrowStructure} shortCut="">
                    ...
                    <OptionContainer selected={String(mainState.arrowStructure)} value="sharp" onClick={handleArrowStructure} shortCut="">
    ...
    return (
        <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="absolute hidden grid-cols-3 top-[50%] right-[-80px] z-10 shadow bg-[var(--background)]  p-2 rounded gap-2"
                ...
                id={`arrow-${type}`}
            >
                <OptionContainer selected={""} value="none" onClick={handleArrowType} shortCut="">
                    <NoneSVG />
                </OptionContainer>
                <OptionContainer selected={""} value="arrow" onClick={handleArrowType} shortCut="">
                    <HeadArrowSVG />
                </OptionContainer>
                <OptionContainer selected={""} value="triangle" onClick={handleArrowType} shortCut="">
                    <TriangleSVG />
                </OptionContainer>
                <OptionContainer selected={""} value="circle" onClick={handleArrowType} shortCut="">
                    <CircleHeadSVG />
                </OptionContainer>
                <OptionContainer selected={""} value="line" onClick={handleArrowType} shortCut="">
                    <LineSVG />
                </OptionContainer>
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row md:items-center gap-2" onClick={() => flip("x")}>
                <OptionContainer selected={""} value="18" onClick={() => { }} shortCut="">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2" onClick={() => flip("y")}>
                <OptionContainer selected={""} value="25" onClick={() => { }} shortCut="">
...
function FontSize() {
    ...
    return (
        <fieldset className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-3">
                <OptionContainer selected={String(mainState.fontSize)} value="18" onClick={changeFontSize} shortCut="">
                    <span>S</span>
                </OptionContainer>
                <OptionContainer selected={String(mainState.fontSize)} value="25" onClick={changeFontSize} shortCut="">
                    <span>M</span>
                </OptionContainer>
                <OptionContainer selected={String(mainState.fontSize)} value="30" onClick={changeFontSize} shortCut="">
                    <span>L</span>
                </OptionContainer>
            </div>
        </fieldset>
...
function FontFamily() {
    ...
    return (
        <fieldset className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-3">
                <OptionContainer selected={mainState.fontFamily} value="Kalam" onClick={changeFontFamily} shortCut="">
                ...
                <OptionContainer selected={mainState.fontFamily} value="Arial" onClick={changeFontFamily} shortCut="">
                    <span>A</span>
                </OptionContainer>

                <OptionContainer selected={mainState.fontFamily} value="Sans Serif" onClick={changeFontFamily} shortCut="">
                    <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
...
function TextStyles() {
    ...
    return (
        <fieldset className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-3">
                <OptionContainer selected={mainState.textBold ? "bold" : ""} value="bold" onClick={() => handleStyle("textBold")} shortCut="">
                ...
                <OptionContainer selected={mainState.textItalic ? "italic" : ""} value="italic" onClick={() => handleStyle("textItalic")} shortCut="">
                ...
                <OptionContainer selected={mainState.textUnderline ? "underline" : ""} value="underline" onClick={() => handleStyle("textUnderline")} shortCut="">
                    <svg viewBox="0 0 24 24" height="18px" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                <OptionContainer selected={mainState.textStrikethrough ? "strike" : ""} value="strike" onClick={() => handleStyle("textStrikethrough")} shortCut="">
...
function TextAlign() {
    ...
    return (
        <fieldset className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-3">
                <OptionContainer selected={mainState.textAlign} value="left" onClick={changeAlignment} shortCut="">
                ...
                <OptionContainer selected={mainState.textAlign} value="center" onClick={changeAlignment} shortCut="">
                    <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 24 24" fill="none" strokeWidth="2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                ...
                <OptionContainer selected={mainState.textAlign} value="right" onClick={changeAlignment} shortCut="">
                    <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 24 24" fill="none" strokeWidth="2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                        <g stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
function OptionContainer({ selected, value, onClick, children, shortCut }: { selected: string, value: string, onClick: (val: string) => void, children: React.ReactNode, shortCut: string }) {
    return (
...
export function Actions() {
    ...
    return (
        <fieldset className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-3">
                <OptionContainer selected={selected} value="copy" onClick={handleCopy} shortCut="ctrl + d">
                ...
                <OptionContainer selected={""} value="Flip horizontally" onClick={() => flipX()} shortCut="ctrl + shift + x">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M15.97 15.25h-2.72c-5.3 0-9.5-2.15-9.5-4.5s4.2-4.5 9.5-4.5c3.03 0 5.82.7 7.62 1.86a.75.75 0 1 0 .81-1.26c-2.06-1.33-5.13-2.1-8.43-2.1-6.02 0-11 2.55-11 6s4.98 6 11 6h2.8l-2.3 2.3a.75.75 0 1 0 1.07 1.05l2.83-2.82c.68-.69.68-1.8 0-2.48l-2.83-2.83a.75.75 0 0 0-1.06 1.06l2.21 2.22z"></path></svg>
                </OptionContainer>
                <OptionContainer selected={""} value="Flip vertically" onClick={() => { flipY() }} shortCut="ctrl + shift + y">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M15.25 8.35v2.4c0 5.3-2.15 9.5-4.5 9.5s-4.5-4.2-4.5-9.5c0-3.03.7-5.82 1.86-7.62a.75.75 0 1 0-1.26-.81c-1.33 2.06-2.1 5.13-2.1 8.43 0 6.02 2.55 11 6 11s6-4.98 6-11V8.27l2.3 2.3A.75.75 0 1 0 20.1 9.5l-2.82-2.83a1.75 1.75 0 0 0-2.48 0L11.97 9.5a.75.75 0 1 0 1.06 1.06l2.22-2.22z"></path></svg>
                </OptionContainer>
            </div>
        </fieldset>
    ...
    return (
        <fieldset className="flex flex-col gap-2">
            ...
            <div className="flex gap-1">
                <OptionContainer selected={selected} value="to-back" onClick={handleSelect} shortCut="ctrl + shift + [">
                ...
                <OptionContainer selected={selected} value="step-backward" onClick={handleSelect} shortCut="ctrl + [">
                ...
                <OptionContainer selected={selected} value="to-front" onClick={handleSelect} shortCut="ctrl + shift + ]">
                ...
                <OptionContainer selected={selected} value="step-forward" onClick={handleSelect} shortCut="ctrl + ]">
