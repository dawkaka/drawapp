    ...
    return (
        ...
        >
            <div className="flex gap-2 md:grid grid-cols-4 md:gap-1">
                <CanvasTool onClick={() => setState({ ...app, tool: "move" })} tool="move" selectedTool={tool} shortCut={"m"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "select" })} tool="select" selectedTool={tool} shortCut={"s"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "rectangle" })} tool="rectangle" selectedTool={tool} shortCut={"r"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "diamond" })} tool="diamond" selectedTool={tool} shortCut={"d"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "ellipse" })} tool="ellipse" selectedTool={tool} shortCut={"e"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "arrow" })} tool="arrow" selectedTool={tool} shortCut={"a"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "line" })} tool="line" selectedTool={tool} shortCut={"l"}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "pencil" })} tool="pencil" selectedTool={tool} shortCut={"p"}>
                    <div style={{ width: "22px", height: "22px" }}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "text" })} tool="text" selectedTool={tool} shortCut={"t"}>
                    <div style={{ width: "22px", height: "22px" }}>
                ...
                <CanvasTool onClick={() => setState({ ...app, tool: "image" })} tool="image" selectedTool={tool} shortCut={""}>
                ...
                <CanvasTool onClick={deleteSelectedItem} tool="eraser" selectedTool={tool} shortCut={""}>
...
export function CanvasTool({ onClick, tool, selectedTool, children, shortCut }: { onClick: () => void, tool: Tool, selectedTool: Tool, children: ReactNode, shortCut: String }) {
    return (
