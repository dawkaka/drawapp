  ...
  return (
    <>
      <fieldset className="flex flex-col gap-2">
        <legend className="text-sm text-[var(--accents-5)] mb-1">
          Arrow type
        </legend>
      ...
      <fieldset className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap gap-3">
          <OptionContainer
            selected={String(mainState.arrowStructure)}
            value="curve"
            onClick={handleArrowStructure}
            shortCut=""
          >
            <svg
              fill="currentColor"
          ...
          >
            ...
            >
              ...
              ></g>
              <g id="SVGRepo_iconCarrier">
                <title>arrow_up [#369]</title> <desc>Created with Sketch.</desc>{' '}
                <defs> </defs>{' '}
                <g
                  id="Page-1"
                  stroke="none"
                ...
                >
                  <g
                    ...
                    transform="translate(-180.000000, -6559.000000)"
                    fill="currentColor"
                  >
                    <g id="icons" transform="translate(56.000000, 160.000000)">
                      <path
                        d="M142,6417.146 L142,6402.828 L138.684,6406.071 L137.234,6404.657 C139.355,6402.535 140.728,6401.144 142.872,6399 C144.938,6401.066 146.515,6402.652 148.52,6404.657 L147.174,6406.071 L144,6402.828 L144,6419.146 L124,6419.146 L124,6399.146 L126,6399.146 L126,6417.146 L142,6417.146 Z"
                        id="arrow_up-[#369]"
                      ></path>
                    </g>
                  </g>
...
function ArrowHeadPicker({
  ...
  return (
    <div className="relative" onClick={(e) => e.stopPropagation()}>
      <button
        className={`w-fit p-1 rounded hover:bg-[var(--p-light)] hover:text-[var(--p-dark)] text-[var(--accents-7)]`}
        onClick={showOpts}
        style={{
      ...
      <div
        className="absolute hidden grid-cols-3 top-[50%] right-[-80px] z-10 shadow bg-[var(--background)]  p-2 rounded gap-2"
        style={{
          transform:
            type === 'head' ? 'rotateY(180deg) scale(0.8)' : 'scale(0.8)',
        }}
        id={`arrow-${type}`}
      >
        <OptionContainer
...
function FontSize() {
  ...
  return (
    <fieldset className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap gap-3">
        <OptionContainer
          selected={String(mainState.fontSize)}
          value="18"
...
function TextStyles() {
  ...
  return (
    <fieldset className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap gap-3">
        <OptionContainer
          selected={mainState.textBold ? 'bold' : ''}
          value="bold"
          onClick={() => handleStyle('textBold')}
          shortCut=""
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <OptionContainer
          selected={mainState.textItalic ? 'italic' : ''}
          value="italic"
          onClick={() => handleStyle('textItalic')}
          shortCut=""
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <OptionContainer
          selected={mainState.textUnderline ? 'underline' : ''}
          value="underline"
          onClick={() => handleStyle('textUnderline')}
          shortCut=""
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <OptionContainer
          selected={mainState.textStrikethrough ? 'strike' : ''}
          value="strike"
          onClick={() => handleStyle('textStrikethrough')}
          shortCut=""
        >
          <svg
            viewBox="0 0 24 24"
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              >
                ...
                <g id="Text-Strikethrough">
                  ...
                  <path
                    d="M18,6 L18,13 C18,16.3137 15.3137,19 12,19 L12,19 C8.68629,19 6,16.3137 6,13 L6,6"
                    id="Path"
                    stroke="currentColor"
                    stroke-width="2"
                    stroke-linecap="round"
...
export function Opacity() {
  ...
  return (
    <div className="w-full">
      ...
      <input
        type="range"
        className="accent-[var(--p-dark)] cursor-resize w-full"
...
function OptionContainer({
  ...
  return (
    <button
      className={`w-fit p-1 rounded hover:bg-[var(--p-light)] hover:text-[var(--p-dark)] ${
        selected === value ? 'text-[var(--p-dark)]' : 'text-[var(--accents-7)]'
      }`}
      onClick={() => onClick(value)}
      style={{
        backgroundColor: selected === value ? 'var(--p-light)' : '',
        border: `1px solid ${
          selected === value ? 'var(--p-light)' : 'var(--accents-2)'
        }`,
...
export function Actions() {
  ...
  function handleCopy() {
    if (selectedItem) {
      ...
      let bounds = getMultipleSelectionBounds(
        appState.multipleSelections,
        items
      );
...
export function Layers() {
  ...
  function handleSelect(val: string) {
    if (selectedItem) {
      const updatedItemLayer = moveItemPosition(
        val as LayerMoves,
        selectedItem,
        items
      );
  ...
  return (
    <fieldset className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap gap-2">
        <FillOption
          option={2}
          selectedOption={mainState.strokeWidth}
          onClick={width}
        />
        <FillOption
          option={3}
  ...
  return (
    <fieldset className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap gap-2">
        <Radius
          option={0}
          selectedOption={mainState.borderRadius}
...
export function Radius({
  ...
  return (
    <button
      className="w-fit p-2 flex items-center justify-center rounded hover:bg-[var(--p-light)] text-[var(--accents-7)] hover:text-[var(--p-dark)]"
      onClick={() => onClick(option)}
      style={{
        backgroundColor: selectedOption === option ? 'var(--p-light)' : '',
        border: `1px solid ${
          selectedOption === option ? 'var(--p-light)' : 'var(--accents-2)'
        }`,
        transform: 'scale(0.9)',
      }}
      title={String(option)}
    >
      ...
      >
        <span
          ...
          style={{
            border: `2px solid ${
              selectedOption === option ? 'var(--p-dark)' : 'currentColor'
            }`,
...
function StrokeStyleOption({
  onClick,
  option,
  selectedOption,
}: {
  onClick: (val: Stroke) => void;
  option: Stroke;
  selectedOption: Stroke;
}) {
  return (
    <button
      className="w-fit p-2 flex items-center justify-center rounded hover:bg-[var(--p-light)] text-[var(--accents-7)] hover:text-[var(--p-dark)]"
