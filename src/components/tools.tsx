...
export default function Tools() {
  ...
  function deleteSelectedItem() {
    if (selectedItem) {
      ...
      let newItems = items.filter(
        (i) => !app.multipleSelections.includes(i.id)
      );
      setItems(newItems);
  ...
  return (
    <div
      className="bg-[var(--background)] rounded-lg px-2 py-1 shadow md:m-3 md:p-3 md:rounded tools"
      style={{
        isolation: 'isolate',
        zIndex: -1,
      }}
    >
      <div className="flex gap-2 md:grid grid-cols-4 md:gap-1">
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'move' })}
          tool="move"
          selectedTool={tool}
          shortCut={'m'}
        >
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <g>
                ...
                <path
                  className="st0"
                  d="M491.258,390.579c0,0-33.165-72.935-46.424-92.832c-13.26-19.898-29.838-26.527-53.046-23.217 c-14.037,2.004-49.916,5.222-76.08,7.458l-89.91-77.892c-11.637-10.321-29.432-16.478-39.753-4.859 c-10.304,11.638-7.631,33.099,8.492,48.784l87.882,76.047c-6.266,12.762-19.16,41.4-16.628,56.571 c3.328,19.888,43.768,58.409,43.768,58.409c6.149,8.202,14.417,14.575,23.919,18.44l63.574,16.951l33.157,22.1L512,412.537 L491.258,390.579z"
                ></path>
                <path
                  className="st0"
                  d="M301.555,222.189v20.568l2.682,2.384c1.507-0.125,2.947-0.257,4.42-0.382l70.65-39.645l-77.752-43.61v26.552 H239.86l38.504,34.134H301.555z"
                ></path>
                <path
                  className="st0"
                  d="M172.587,179.895c7.102-6.423,16.248-9.924,26.213-9.924c2.599,0,5.256,0.24,7.913,0.712V93.229h26.568 l-43.627-77.768l-43.627,77.768h26.56V179.895z"
                ></path>
                <path
                  className="st0"
                  d="M165.742,188.056h-87.99v-26.552L0,205.114l77.752,43.627v-26.552h81.36 C157.225,209.932,159.344,197.889,165.742,188.056z"
                ></path>
                <path
                  className="st0"
                  d="M206.712,284.621l-26.892-23.846l-0.323-0.306c-2.541-2.483-4.817-5.099-6.911-7.789v64.335h-26.56 l43.627,77.752l43.627-77.752h-26.568V284.621z"
                ></path>
              </g>
            </g>
          </svg>
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'select' })}
          tool="select"
          selectedTool={tool}
          shortCut={'s'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'rectangle' })}
          tool="rectangle"
          selectedTool={tool}
          shortCut={'r'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'diamond' })}
          tool="diamond"
          selectedTool={tool}
          shortCut={'d'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'ellipse' })}
          tool="ellipse"
          selectedTool={tool}
          shortCut={'e'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'arrow' })}
          tool="arrow"
          selectedTool={tool}
          shortCut={'a'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'line' })}
          tool="line"
          selectedTool={tool}
          shortCut={'l'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'pencil' })}
          tool="pencil"
          selectedTool={tool}
          shortCut={'p'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'text' })}
          tool="text"
          selectedTool={tool}
          shortCut={'t'}
        >
        ...
        <CanvasTool
          onClick={() => setState({ ...app, tool: 'image' })}
          tool="image"
          selectedTool={tool}
          shortCut={''}
        >
          <input
            type="file"
            className="absolute h-[22px] w-[22px] top-0 left-0 opacity-0"
...
export function CanvasTool({
  ...
  return (
    <button
      className={`w-fit p-2 rounded hover:bg-[var(--p-light)]  hover:text-[var(--p-dark)] ${
        selectedTool === tool
          ? 'text-[var(--p-dark)]'
          : 'text-[var(--accents-7)]'
      }`}
      ...
      title={`${tool}__${shortCut}`}
    >
      <div className="relative h-[22px] w-[22px]">{children}</div>
    </button>
  );
}
