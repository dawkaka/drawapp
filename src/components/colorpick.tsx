...
function Stroke() {
    ...
    return (
        <div className="flex flex-col gap-1 items-center">
            ...
            <div className="hidden fixed top-[90px] left-[10px] z-20 p-2 bg-[var(--background)] grid-cols-5 gap-1 w-max"
                id="stroke-picker"
                ref={strokeRef}
            >
                {
                ...
                <div className="h-[25px] w-[25px] relative bg-gradient-to-br rounded overflow-hidden">
                    <input type="color" className="opacity-0" onChange={(e) => updateColor(e.target.value)} />
                </div>
            </div>
        </div>
    )
...
function Fill() {
    ...
    return (
        <div className="relative w-full">
            ...
            <div className="hidden fixed z-20 p-2 bg-[var(--background)] grid-cols-5 gap-1 w-max"
                id="fill-picker"
                ref={fillRef}
            >
                {
