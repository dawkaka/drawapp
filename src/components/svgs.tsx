    ...
    return (
        <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 40 20">
            <g stroke="currentColor" fill="currentColor" transform="">
                <path d="M32 10L6 10" stroke-width="2">
                </path><path d="M27.5 5.5L34.5 10L27.5 14.5L27.5 5.5"></path>
            </g>
        </svg>
    )
}
...
export function LineSVG() {
    return (
        <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 40 20">
            <g transform="">
                <path d="M34 10H5.99996M34 10L34 5M34 10L34 15" stroke="currentColor" stroke-width="2" fill="none">
                </path>
            </g>
        </svg>
    )
